    ...
    <div class="page-container">
        <div class="form form-horizontal" id="form-article-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data3); ?>" placeholder="" id="" name="contract_year">
                </div>
            </div>
            <div class="row cl">
...
<script type="text/javascript" src="/audit/Public/lib/laypage/1.2/laypage.js"></script>
    ...
    $(".submit").on('click', function() {
        ...
        var contract_year = $("input[name='contract_year']").val(); 
