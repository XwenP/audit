...
<article class="cl pd-20">
	<div class="form form-horizontal" id="form-change-password">
        <div id="itemid" itemid="<?php echo ($data["item_id"]); ?>" style="display: none"></div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">分表名:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" autocomplete="off" value="<?php echo ($data["item_name"]); ?>" placeholder="" name="item_name" id="item_name">
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">投资监理单位:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="<?php echo ($data["su_company"]); ?>" placeholder="" name="su_company" id="su_company">
            </div>
        </div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">投资监理:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" autocomplete="off" value="<?php echo ($data["item_supervisor"]); ?>" placeholder="" name="item_supervisor" id="item_supervisor">
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    ...
    $(".submit").on('click',function(){
    	...
    	$.ajax({
            type: "POST",
            url: "/audit/index.php/Home/System/item_save",
