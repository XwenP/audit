...
<body>
    <article class="cl pd-20">
        <div class="form form-horizontal" id="form-change-password">
            ...
            <div class="row cl">
                <label class="form-label col-xs-3 col-sm-2"><strong>合同名称：</strong></label>
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["contract_name"]); ?>" placeholder="" id="" name="contract_name">
                </div>
            </div>
            <div class="row cl">
...
<script type="text/javascript" src="/audit/Public/lib/laypage/1.2/laypage.js"></script>
    ...
    $(".submit").on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "/audit/index.php/Home/Index/name_save",
            data: "contract_id=" + contract_id + "&contract_name=" + contract_name,
