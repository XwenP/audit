...
<!--/_header 作为公共模版分离出去-->
    ...
    <aside class="Hui-aside">
        <div class="menu_dropdown bk_2">
            ...
            <dl>
                <dt><a href="/audit/index.php/Home/System/typist" style="text-decoration:none; color:#148cf1;"><i class="Hui-iconfont">&#xe70c;&nbsp;</i> 打字员管理</a></dt>
            </dl>
        </div>
    </aside>
        ...
        <div class="Hui-article">
            <article class="cl pd-20">
                <div class="cl pd-5 bg-1 bk-gray mt-10">
                    <span class="l">
                        <a href="javascript:;" onclick="list_add('添加打字员','/audit/index.php/Home/System/typist_add','','400','200')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe644;</i> 添加打字员</a>
                    </span>
                    ...
                    <table class="table table-border table-bordered table-hover table-bg table-sort">
                        ...
                        <tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="text-c">
                                ...
                                <td class="td-manage">
                                    <a title="删除" href="javascript:;" onclick="typist_del(<?php echo ($v["id"]); ?>)" class="ml-5 delete" style="text-decoration:none" ><i class="Hui-iconfont">&#xe6e2;</i></a>
                                </td>
...
<script type="text/javascript" src="/audit/Public/lib/laypage/1.2/laypage.js"></script>
    ...
    function typist_del(id){
        layer.confirm('确定删除?', function(index) {
            $.ajax({
                type: 'POST',
                url: "/audit/index.php/Home/System /typist_del",
                data: "id=" + id,
                cache: false,
