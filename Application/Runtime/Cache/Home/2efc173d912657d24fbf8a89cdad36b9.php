...
<body>
    <div id="year" year="<?php echo ($data["bel_year"]); ?>" itid="<?php echo ($data["id"]); ?>" style="display: none"></div>
    <div class="page-container">
        <div class="form form-horizontal" id="form-article-add">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>序号：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["num"]); ?>" placeholder="" id="" name="num">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>工程名称：</strong></label>
                <div class="formControls col-xs-6 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["item_name"]); ?>" placeholder="" id="" name="item_name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>送审日期：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["vote_time"]); ?>" placeholder="" id="" name="vote_time">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>完成日期：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["finish_time"]); ?>" placeholder="" id="" name="finish_time">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>文号：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["symbol"]); ?>" placeholder="" id="" name="symbol">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>建设单位：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["build_unit"]); ?>" placeholder="" id="" name="build_unit">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>施工单位：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["constroct_unit"]); ?>" placeholder="" id="" name="constroct_unit">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>原决算额：</strong></label>
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" class="input-text" value="<?php echo ($data["inital_money"]); ?>" placeholder="" id="" name="inital_money">
                </div>
                <label class="form-label col-xs-4 col-sm-1"><strong>审定金额：</strong></label>
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="text" class="input-text" value="<?php echo ($data["audit_money"]); ?>" placeholder="" id="" name="audit_money">
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" class="input-text" value="<?php echo ($data["assess_money"]); ?>" placeholder="" id="" name="assess_money">
                </div>
                <label class="form-label col-xs-4 col-sm-1"><strong>核减率：</strong></label>
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" class="input-text" value="<?php echo ($data["rate"]); ?>" placeholder="" id="" name="rate">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>甲方审价费：</strong></label>
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" class="input-text" value="<?php echo ($data["trial_a"]); ?>" placeholder="" id="" name="trial_a">
                </div>
                <label class="form-label col-xs-4 col-sm-1"><strong>乙方审价费：</strong></label>
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" class="input-text" value="<?php echo ($data["trial_b"]); ?>" placeholder="" id="" name="trial_b">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>实际收用甲方：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($data["trial_a_rel"]); ?>" placeholder="" id="" name="trial_a_rel">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box">
                        <select name="assessor" class="select" id="select_class">
                            <?php if(is_array($list)): foreach($list as $key=>$v): if($v["abbreviation"] == $data['assessor']): ?><option selected="selected" value="<?php echo ($v["abbreviation"]); ?>"><?php echo ($v["abbreviation"]); ?></option>
                                    <?php else: ?>
                                    <option value="<?php echo ($v["abbreviation"]); ?>"><?php echo ($v["abbreviation"]); ?></option><?php endif; endforeach; endif; ?>
                        </select>
                    </span>
                </div>
            </div>
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <button class="btn btn-primary radius submit" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存</button>
