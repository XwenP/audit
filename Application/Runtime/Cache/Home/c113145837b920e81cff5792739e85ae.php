...
<!--/_header 作为公共模版分离出去-->
    ...
    <aside class="Hui-aside">
        <div class="menu_dropdown bk_2">
            <dl>
                <dt><a href="/audit/index.php/Home/System/index" style="text-decoration:none; color:#148cf1;"><i class="Hui-iconfont">&#xe72d;&nbsp;</i> 分表项目管理</a></dt>
            </dl>
            <dl>
                <dt><a href="/audit/index.php/Home/System/checker" style="text-decoration:none;"><i class="Hui-iconfont">&#xe62d;&nbsp;</i> 审核员管理</a></dt>
            </dl>
            <dl>
                <dt><a href="/audit/index.php/Home/System/admin" style="text-decoration:none;"><i class="Hui-iconfont">&#xe62b;&nbsp;</i> 管理员账号管理</a></dt>
            </dl>
            <dl>
    ...
    <section class="Hui-article-box">
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 系统管理 <span class="c-gray en">&gt;</span> 分表项目管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        <div class="Hui-article">
            <article class="cl pd-20">
                <div class="cl pd-5 bg-1 bk-gray mt-10">
                    <span class="l">
                        <a href="javascript:;" onclick="list_add('添加分表','/audit/index.php/Home/Index/list_add','','400','280')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe644;</i> 添加合同分表</a>
                    </span>
                    ...
                    <table class="table table-border table-bordered table-hover table-bg table-sort">
                        ...
                        <tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="text-c">
                                ...
                                <td><?php echo ($v["su_company"]); ?></td>
                                <td><?php echo ($v["item_supervisor"]); ?></td>
                                <td class="td-manage">
                                    <a title="编辑" href="javascript:;" onclick="list_add('编辑分表','/audit/index.php/Home/System/item_edit?item_id=<?php echo ($v["item_id"]); ?>','','400','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                                </td>
