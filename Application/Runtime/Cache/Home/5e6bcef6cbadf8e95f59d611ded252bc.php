        ...
        <div class="form form-horizontal" id="pay">
            <table class="table table-border table-bordered table-hover table-bg">
                ...
                <tbody>
                    <tr>
                        <td>
                            <textarea name="contract_remarks" cols="" rows="" class="remarks2 textarea" placeholder="备注" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,500)"><?php echo ($data["contract_remarks"]); ?></textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<script type="text/javascript" src="/audit/Public/lib/laypage/1.2/laypage.js"></script>
    ...
    $(".baochun").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "/audit/index.php/Home/Before/list_edit4",
