        ...
        <div class="menu_dropdown bk_2">
            <dl>
                ...
                <dd style="display: block;">
                    <ul>
                        <li class="current"><a href="/audit/index.php/Home/Index/index?" title="<?php echo ($count_year); ?>年合同总表"><?php echo ($count_year); ?>年工程项目合同付款登记表</a></li>
                    </ul>
                </dd>
            </dl>
            <dl>
        ...
        <div class="Hui-article">
            <article class="cl pd-20">
                <div class="cl pd-5 bg-1 bk-gray mt-10">
                    <span class="l">
                        <a href="javascript:;" onclick="context_add('添加合同','/audit/index.php/Home/Index/context_add?year=<?php echo ($count_year); ?>')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加合同</a>
                        <a href="/audit/index.php/Home/Index/test2?year=<?php echo ($count_year); ?>" class="btn btn-success radius"><i class="Hui-iconfont">&#xe644;</i> 导出总表</a>
                    </span>
                    ...
                    <table class="table table-border table-bordered table-hover table-bg table-sort">
                        ...
                        <?php if(!empty($contract)): ?><tbody>
                                <?php if(is_array($contract)): foreach($contract as $key=>$v): ?><tr>
                                        <td class="text-c"><a href="/audit/index.php/Home/Index/list_show?item_id=<?php echo ($v['item_id']); ?>"><?php echo ($v["contract_id"]); ?></a></td>
                                        ...
                                        <td class="text-c">
                                            <a style="text-decoration:none" onClick="context_edit('合同编辑','/audit/index.php/Home/Index/context_edit?id=<?php echo ($v["id"]); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                        </td>
