...
<body>
    <div style="display: none" id="id111"><?php echo ($arr["id"]); ?></div>
    <div class="page-container">
        <div class="form form-horizontal" id="form-article-add">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>序号：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($arr["contract_id"]); ?>" placeholder="" id="" name="contract_id">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>合同名称：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($arr["contract_name"]); ?>" placeholder="" id="" name="contract_name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>承包单位：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($arr["contract_unit"]); ?>" placeholder="" id="" name="contract_unit">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box">
                        <select id="select_class1" name="item_id" class="select">
                            <?php if(is_array($data1)): foreach($data1 as $key=>$v): if($v["item_name"] == $arr['item']['item_name']): ?><option selected="selected" value="<?php echo ($v["item_id"]); ?>" item_supervisor="<?php echo ($v["item_supervisor"]); ?>"><?php echo ($v["item_name"]); ?></option>
                                    <?php else: ?>
                                    <option value="<?php echo ($v["item_id"]); ?>" item_supervisor="<?php echo ($v["item_supervisor"]); ?>"><?php echo ($v["item_name"]); ?></option><?php endif; endforeach; endif; ?>
                        </select>
                    </span>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($arr["item_supervisor"]); ?>" placeholder="" id="" name="item_supervisor">    
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box">
                        <select name="contract_nature" class="select" id="select_class">
                            <option value="<?php echo ($arr["contract_nature"]); ?>"><?php echo ($arr["contract_nature"]); ?></option>
            ...
            <?php if($state == 1): ?><div class="extra" style="display: block" ison="1">
                <?php else: ?>
                    <div class="extra" style="display: none" ison="0"><?php endif; ?>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><strong class="c-red">总投资金额：</strong></label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="<?php echo ($arr["total_invest"]); ?>" placeholder="" id="" name="total_invest">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><strong class="c-red">建安费：</strong></label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="<?php echo ($arr["jian_fee"]); ?>" placeholder="" id="" name="jian_fee">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><strong class="c-red">预算金额：</strong></label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="<?php echo ($arr["budget_amount"]); ?>" placeholder="" id="" name="budget_amount">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><strong class="c-red">控制价：</strong></label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="<?php echo ($arr["limit_price"]); ?>" placeholder="" id="" name="limit_price">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><strong class="c-red">招标项目类别：</strong></label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="<?php echo ($arr["item_type"]); ?>" placeholder="" id="" name="item_type">
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($arr["contract_amount"]); ?>" placeholder="" id="" name="contract_amount">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>合同流转日期：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo ($arr["contract_date"]); ?>" placeholder="" id="" name="contract_date">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>合同付款方式：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="contract_remarks" cols="" rows="" class="remarks1 textarea" placeholder="备注" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,500)"><?php echo ($arr["contract_remarks"]); ?></textarea>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><strong>额外备注：</strong></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="contract_remarks_extra" cols="" rows="" class="remarks2 textarea" placeholder="备注" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,500)"><?php echo ($arr["contract_remarks_extra"]); ?></textarea>
                </div>
            </div>
            <div class="row cl">
...
<script type="text/javascript" src="/audit/Public/lib/laypage/1.2/laypage.js"></script>
    ...
    $(".submit").on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "/audit/index.php/Home/Before/contract_save",
